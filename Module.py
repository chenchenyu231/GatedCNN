...
def generator_gatedcnn(inputs, num_features, reuse = False, scope_name = 'generator_gatedcnn'):
...
def generator_dnn(inputs, num_features, reuse = False, scope_name = 'generator_dnn'):
...
#        h1 = dense_layer(inputs = inputs_reshape, units = 1024, activation = tf.sigmoid, name = 'h1_dense')
        ...
        # Output
        o1 = dense_layer(inputs = h5, units = num_features, activation = None, name = 'o1_dense')
